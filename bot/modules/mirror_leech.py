...
def _mirror_leech(bot, message, isZip=False, extract=False, isQbit=False, isLeech=False):
    ...
    if not is_url(link) and not is_magnet(link):
        ...
        help_msg += "\n<b>یا میتوانید فایل تورنت را فرستاده و روی آن ریپلای کنید و دستور موردنظر را بفرستید</b>"
        ...
        help_msg += "\n<b>یا میتوانید فایل یا لینک را فرستاده و روی آن ریپلای کنید و دستور موردنظر را بفرستید</b>"
